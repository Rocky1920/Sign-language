...
if app_mode == "About App":
    ...
    st.markdown(
        """
              # About Me \n 
                Hey , we are Working on the detaction of sign language with the help of movement of hand and finger points-tips and converting alphabets into the hand signs**. \n
                """
    )
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmark in results.multi_hand_landmarks:
                ...
                # ):
                #     cv2.putText(
                #         img, "J", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3
                #     )
                #     my_list.append("J")
                ...
                # ):
                #     cv2.putText(
                #         img, "Z", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3
                #     )
                #     my_list.append("Z")
